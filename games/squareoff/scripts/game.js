...
var _statesWait = require('states/Wait');

var _statesWait2 = _interopRequireDefault(_statesWait);
...
var Game = (function (_Phaser$Game) {
    ...
    function Game() {
        ...
        _get(Object.getPrototypeOf(Game.prototype), 'constructor', this).call(this, _config2['default'].CANVAS.WIDTH, _config2['default'].CANVAS.HEIGHT, Phaser.AUTO, 'phaser-canvas', null, false, false);

        // Create the game states
        this.state.add('BootState', _statesBoot2['default'], false);
        this.state.add('PreloadState', _statesPreload2['default'], false);
        this.state.add('GameState', _statesGame2['default'], false);
        this.state.add('MainmenuState', _statesMainmenu2['default'], false);
        this.state.add('WaitState', _statesWait2['default'], false);
...
},{"config":64,"states/Boot":7,"states/Game":8,"states/Mainmenu":9,"states/Preload":10,"states/Wait":11}],2:[function(require,module,exports){
'use strict';
...
var BlockObject = (function (_Phaser$Sprite) {
    _inherits(BlockObject, _Phaser$Sprite);

    function BlockObject(game, grid, grid_x, grid_y, key, blockSize, color) {
        _classCallCheck(this, BlockObject);

        var x = game.world.centerX - grid.gridWidth / 2 + grid.blockWidth / 2 + grid_x * grid.blockWidth;
        var y = game.world.centerY - grid.gridHeight / 2 + grid.blockHeight / 2 + grid_y * grid.blockHeight;
        _get(Object.getPrototypeOf(BlockObject.prototype), 'constructor', this).call(this, game, x, y, key, 0);
        this.anchor.x = 0.5;
        this.anchor.y = 0.5;
    ...
    _createClass(BlockObject, [{
        ...
        value: function update() {
            _get(Object.getPrototypeOf(BlockObject.prototype), 'update', this).call(this);
        }
    }]);
...
},{"../config":64}],3:[function(require,module,exports){
"use strict";
...
var ButtonObject = (function (_Phaser$Button) {
    _inherits(ButtonObject, _Phaser$Button);

    function ButtonObject(game, grid, grid_x, grid_y, blockSize, socket, color) {
        var hoverCallback = arguments.length <= 7 || arguments[7] === undefined ? function () {} : arguments[7];

        _classCallCheck(this, ButtonObject);

        var x = game.world.centerX - grid.gridWidth / 2 + grid_x * grid.blockWidth;
        var y = game.world.centerY - grid.gridHeight / 2 + grid_y * grid.blockHeight;

        // configure button
        _get(Object.getPrototypeOf(ButtonObject.prototype), "constructor", this).call(this, game, x, y, null, null, null, 1, 0, 0, 0);
        this.onInputDown.add(function () {
            socket.emit("mouse_click", grid_x, grid_y);
        });
        this.onInputOver.add(function () {
            if (grid_y >= _config2["default"].GOAL.SAFE_ZONE) {
...
exports["default"] = ButtonObject;
module.exports = exports["default"];

},{"../config":64}],4:[function(require,module,exports){
'use strict';
...
var DiscObject = (function (_Phaser$Sprite) {
    _inherits(DiscObject, _Phaser$Sprite);

    function DiscObject(game, x, y, key, blockSize) {
        _classCallCheck(this, DiscObject);

        _get(Object.getPrototypeOf(DiscObject.prototype), 'constructor', this).call(this, game, x, y, key, 0);
        ...
        this.width = this.height = _config2['default'].DISC.DIAMETER * blockSize;
        ...
        this.emitter.minParticleScale = _config2['default'].DISC.DIAMETER * 0.82;
        this.emitter.maxParticleScale = _config2['default'].DISC.DIAMETER * 0.82;
    ...
    _createClass(DiscObject, [{
        key: 'explode',
        value: function explode(direction) {
            this.exploding = true;
        ...
        key: 'update',
        value: function update() {
            _get(Object.getPrototypeOf(DiscObject.prototype), 'update', this).call(this);
            if (!this.exploding) {
        ...
        value: function destroy(destroyChildren) {
            _get(Object.getPrototypeOf(DiscObject.prototype), 'destroy', this).call(this);
            this.emitter.destroy();
            this.initVelocityData();
        }
    }, {
        key: 'initVelocityData',
        value: function initVelocityData() {
...
},{"../config":64}],5:[function(require,module,exports){
'use strict';
...
var GridObject = (function (_Phaser$Graphics) {
    _inherits(GridObject, _Phaser$Graphics);

    function GridObject(game, center_x, center_y, player_color, enemy_color) {
        _classCallCheck(this, GridObject);

        _get(Object.getPrototypeOf(GridObject.prototype), 'constructor', this).call(this, game, center_x, center_y);

        var HEIGHT = game.height - _config2['default'].GRID.PADDING.VERTICAL * 2;
        var WIDTH = HEIGHT * _config2['default'].GRID.WIDTH / _config2['default'].GRID.HEIGHT;
        var hlw = _config2['default'].GRID.LINE_WIDTH / 2;
        var hw = WIDTH / 2;
        var hh = HEIGHT / 2;

        this.blockWidth = WIDTH / _config2['default'].GRID.WIDTH;
        this.blockHeight = HEIGHT / _config2['default'].GRID.HEIGHT;
        this.gridWidth = WIDTH;
        this.gridHeight = HEIGHT;
        this.lineWidth = _config2['default'].GRID.LINE_WIDTH;

        this.lineStyle(_config2['default'].GRID.LINE_WIDTH, 0x222222, 1.0);

        for (var gridX = 0; gridX <= _config2['default'].GRID.WIDTH; gridX += 1) {
            var x = gridX * this.blockWidth;
            this.moveTo(x - hlw - hw, 0 - hlw - hh);
            this.lineTo(x - hlw - hw, HEIGHT + hlw - hh);
        }

        for (var gridY = 0; gridY <= _config2['default'].GRID.HEIGHT; gridY += 1) {
            var y = gridY * this.blockHeight;
            if (gridY === _config2['default'].GRID.HEIGHT - _config2['default'].GOAL.SAFE_ZONE) {
                this.lineStyle(_config2['default'].GRID.LINE_WIDTH, player_color, 0.6);
            } else if (gridY === _config2['default'].GOAL.SAFE_ZONE) {
                this.lineStyle(_config2['default'].GRID.LINE_WIDTH, enemy_color, 0.6);
            } else {
                this.lineStyle(_config2['default'].GRID.LINE_WIDTH, 0x222222, 1.0);
            }
        ...
        var RIM = WIDTH * (_config2['default'].GRID.WIDTH - _config2['default'].GOAL.WIDTH) / _config2['default'].GRID.WIDTH / 2;
        this.lineStyle(_config2['default'].GRID.LINE_WIDTH * 4, enemy_color, 0.8);
        this.moveTo(0 - hlw * 2 - hw + RIM, 0 - hh);
        this.lineTo(WIDTH - hw - RIM, 0 - hh);
        this.lineStyle(_config2['default'].GRID.LINE_WIDTH * 4, player_color, 0.8);
        this.moveTo(0 - hlw * 2 - hw + RIM, _config2['default'].GRID.HEIGHT * this.blockHeight - hh);
        this.lineTo(WIDTH - hw - RIM, _config2['default'].GRID.HEIGHT * this.blockHeight - hh);
    }
...
},{"../config":64}],6:[function(require,module,exports){
'use strict';
...
var ScoreText = (function (_Phaser$Text) {
    ...
    function ScoreText(game, x, y, text, color, size) {
        _classCallCheck(this, ScoreText);

        var template = '#000000';
        var colorValue = color.toString(16);
        var colorString = template.substring(0, template.length - colorValue.length) + colorValue;

        _get(Object.getPrototypeOf(ScoreText.prototype), 'constructor', this).call(this, game, x, y, text, {
...
},{"../config":64}],7:[function(require,module,exports){
'use strict';
...
},{"../config":64}],8:[function(require,module,exports){
'use strict';
...
var _objectsScoreText = require('objects/ScoreText');

var _objectsScoreText2 = _interopRequireDefault(_objectsScoreText);

var _objectsGridObject = require('objects/GridObject');

var _objectsGridObject2 = _interopRequireDefault(_objectsGridObject);

var _objectsDiscObject = require('objects/DiscObject');

var _objectsDiscObject2 = _interopRequireDefault(_objectsDiscObject);

var _objectsBlockObject = require('objects/BlockObject');

var _objectsBlockObject2 = _interopRequireDefault(_objectsBlockObject);

var _objectsButtonObject = require('objects/ButtonObject');

var _objectsButtonObject2 = _interopRequireDefault(_objectsButtonObject);
...
var _commonSchemaJs = require('../../../common/schema.js');

var _commonSchemaJs2 = _interopRequireDefault(_commonSchemaJs);
...
var GameState = (function (_Phaser$State) {
    ...
    _createClass(GameState, [{
        key: 'init',
        value: function init(socket, nick, color, enemy_nick, enemy_color) {
        ...
        value: function create() {
            ...
            this.grid = new _objectsGridObject2['default'](this.game, center.x, center.y, this.player_color, this.enemy_color);
            this.game.gridGroup.add(this.grid);

            this.disc = new _objectsDiscObject2['default'](this.game, center.x, center.y, 'disc-sprite', this.grid.blockWidth);
            ...
            for (var i = 0; i < _config2['default'].GRID.HEIGHT; i++) {
                this.hover_buttons.push([]);
                for (var j = 0; j < _config2['default'].GRID.WIDTH; j++) {
                    var buttonObject = new _objectsButtonObject2['default'](this.game, this.grid, j, i, this.grid.blockWidth, this.socket, this.player_color, function (x, y) {
                        // move the hover sprite to this location
                        _this.hover_sprite_player.position.copyFrom(_this.hover_buttons[y][x].position);
                        _this.hover_sprite_player.position.add(-0.5, 0.5);
                    });
            ...
            var textSize = 35;
            var enemyNameText = new _objectsScoreText2['default'](this.game, center.x + 2, 0, this.enemy_nick, this.enemy_color, textSize);
            var playerNameText = new _objectsScoreText2['default'](this.game, center.x - 2, center.y + this.grid.gridHeight / 2, this.player_nick, this.player_color, textSize);
            this.enemyScoreText = new _objectsScoreText2['default'](this.game, center.x - this.grid.gridWidth / 2 - textSize, 2, '', this.enemy_color, 3 * textSize);
            this.playerScoreText = new _objectsScoreText2['default'](this.game, center.x - this.grid.gridWidth / 2 - textSize, this.game.world.height - 2, '', this.player_color, 3 * textSize);
        ...
        key: 'applyGameState',
        value: function applyGameState(buffer) {
            var gameState = _commonSchemaJs2['default'].tickSchema.decode(buffer);

            // disc x and y are based on p2 coordinate system which has 0,0 at the
            // center.  translate to phaser coordinate system
            var px = gameState.disc.pos.x * this.grid.gridWidth / _config2['default'].GRID.WIDTH + this.game.width / 2;
            var py = gameState.disc.pos.y * this.grid.gridHeight / _config2['default'].GRID.HEIGHT + this.game.height / 2;
            ...
            // add enemy hover
            var hover_block = gameState.hover_block;
            ...
            _lodash2['default'].each(gameState.grid, _lodash2['default'].curry(this.addGridRow.bind(this))(gameState.pos));
        }
    }, {
        key: 'addGridRow',
        value: function addGridRow(player_pos, row, y) {
            var x = row.length;
            while (x--) {
                if (row[x] > 0) {
        ...
        key: 'addGridBlock',
        value: function addGridBlock(x, y, row, player_pos) {
            var color = row[x] === player_pos ? this.player_color : this.enemy_color;
            this.game.blockGroup.add(new _objectsBlockObject2['default'](this.game, this.grid, x, y, 'block-sprite', this.grid.blockWidth, color));
        }
    }, {
        key: 'leaveGameTimout',
        value: function leaveGameTimout() {
            var self = this;
            setTimeout(function () {
                self.socket.emit('leave_instance');
                self.state.start('WaitState', false, false, self.socket, self.player_nick, self.player_color);
            }, _config2['default'].WIN_SCREEN_TIMEOUT);
        }
    }, {
        key: 'displayEndMessage',
        value: function displayEndMessage(msg) {
            ...
            var template = '#000000';
            var colorValue = this.player_color.toString(16);
            var colorString = template.substring(0, template.length - colorValue.length) + colorValue;
...
},{"../../../common/schema.js":12,"../config":64,"lodash":45,"objects/BlockObject":2,"objects/ButtonObject":3,"objects/DiscObject":4,"objects/GridObject":5,"objects/ScoreText":6}],9:[function(require,module,exports){
'use strict';
...
var MainmenuState = (function (_Phaser$State) {
    ...
    function MainmenuState() {
        ...
        _get(Object.getPrototypeOf(MainmenuState.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(MainmenuState, [{
        ...
        value: function create() {
            ...
            var colorButtons = _lodash2['default'].toArray(document.querySelectorAll('.color-picker *'));
            var self = this;
            this.player_color = parseInt(_lodash2['default'].sample(colorButtons).dataset.color.replace('#', ''), 16);
            _lodash2['default'].each(colorButtons, function (button) {
                button.addEventListener('click', function (evt) {
                    // reset all border colors and then set border color on this btn
                    _lodash2['default'].each(colorButtons, function (btn) {
            ...
            document.querySelector('#nick').addEventListener('keydown', function (evt) {
                var Enter = 13;
            ...
            this.socket.on('game_status', function (status) {
        ...
        key: 'enableButtons',
        value: function enableButtons(bool) {
            // enable the play buttons
            var buttons = document.querySelectorAll('#main-menu button');
            _lodash2['default'].each(_lodash2['default'].toArray(buttons), function (el) {
                el.disabled = false;
            });
        }
    }, {
...
},{"lodash":45,"socket.io-client":51}],10:[function(require,module,exports){
'use strict';
...
var WaitState = (function (_Phaser$State) {
    _inherits(WaitState, _Phaser$State);

    function WaitState() {
        _classCallCheck(this, WaitState);

        _get(Object.getPrototypeOf(WaitState.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(WaitState, [{
        key: 'init',
        value: function init(socket, nick, color) {
...
},{"schemapack":50}],13:[function(require,module,exports){
...
},{"base64-js":17,"ieee754":42,"isarray":21}],21:[function(require,module,exports){
...
},{"./transport":30,"./transports":31,"component-emitter":23,"debug":25,"engine.io-parser":37,"indexof":43,"parsejson":47,"parseqs":48,"parseuri":49}],30:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":30,"component-inherit":24,"debug":25,"engine.io-parser":37,"parseqs":48,"xmlhttprequest-ssl":36,"yeast":63}],35:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":30,"component-inherit":24,"debug":25,"engine.io-parser":37,"parseqs":48,"ws":19,"yeast":63}],36:[function(require,module,exports){
...
},{"./keys":38,"after":13,"arraybuffer.slice":14,"base64-arraybuffer":16,"blob":18,"has-binary":39,"utf8":62}],38:[function(require,module,exports){
...
},{"isarray":44}],41:[function(require,module,exports){
...
},{"./manager":52,"./socket":54,"./url":55,"debug":25,"socket.io-parser":58}],52:[function(require,module,exports){
...
},{"./on":53,"./socket":54,"backo2":15,"component-bind":22,"component-emitter":56,"debug":25,"engine.io-client":27,"indexof":43,"socket.io-parser":58}],53:[function(require,module,exports){
...
},{"./on":53,"component-bind":22,"component-emitter":56,"debug":25,"has-binary":40,"socket.io-parser":58,"to-array":61}],55:[function(require,module,exports){
(function (global){
...
},{"debug":25,"parseuri":49}],56:[function(require,module,exports){
...
},{"./is-buffer":59,"isarray":44}],58:[function(require,module,exports){
...
},{"./binary":57,"./is-buffer":59,"component-emitter":23,"debug":25,"isarray":44,"json3":60}],59:[function(require,module,exports){
(function (global){
